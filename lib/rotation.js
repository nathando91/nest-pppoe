...
var queue = new Map();
var io = null;
var activeCount = 0; // Track how many rotations are currently running
...
var MAX_CONCURRENT = 10; // Max parallel rotations
...
function processNext() {
    ...
    var slots = MAX_CONCURRENT - activeCount;
    for (var i = 0; i < Math.min(queued.length, slots); i++) {
        executeRotation(queued[i].id);
    }
}
