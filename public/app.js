        ...
        <div class="account-card" id="account-${idx}">
            ...
            <div class="account-fields">
                ...
                <div class="input-group">
                    <input type="password" class="account-input" id="account-password-${idx}" placeholder="Password" value="${escapeHtml(acc.password || '')}"
                        data-field="password" data-idx="${idx}">
                    <button type="button" class="password-toggle" onclick="togglePasswordField('account-password-${idx}', this)" title="Hiện/Ẩn mật khẩu">
